                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="periode_audit" id="periode_audit"
                                            ...
                                            <option value="I" @selected($data->periode_audit == 'I')>I</option>
                                            <option value="II" @selected($data->periode_audit == 'II')>II</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="proses_audit" id="proses_audit"
                                            ...
                                            <option value="Eksternal" @selected(old('proses_audit') == 'Internal')>Eksternal</option>
                                        </select>
