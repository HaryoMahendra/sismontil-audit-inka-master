                            ...
                            @php
                                $faqs = [
                                    [
                                        'q' => 'Apa itu SIM-TL?',
                                        'a' =>
                                            'SIM-TL adalah Sistem Informasi Monitoring Tindak Lanjut yang digunakan untuk memantau dan mengelola tindak lanjut hasil audit secara terstruktur dan efisien.',
                                    ],
                                    [
                                    ...
                                    [
                                        'q' => 'Di mana saya bisa mendapatkan dokumen manual book penggunaan sistem?',
                                        'a' =>
                                            'Dokumen manual book yang berisikan panduan lengkap penggunaan SIM-TL dapat diakses melalui tautan berikut:<br><br><a href="' .
                                            asset('assets/Manual Book SIMTL.pdf') .
                                            '" target="_blank" class="contact-btn"><i class="fa-solid fa-book"></i> Unduh Manual Book</a><br><br>',
                                    ],
                                    [
                                        'q' => 'Ketika terjadi kendala, harus menghubungi siapa?',
                                        'a' =>
                                            'Anda dapat memilih email salah satu petugas, pilih salah satu:<br><br><a href="' .
                                            url('/hubungi') .
                                            '" class="contact-btn">Hubungi Kami</a>',
                                    ],
                                ];
                            @endphp
